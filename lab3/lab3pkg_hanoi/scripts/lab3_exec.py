...
"""
home = np.radians([-65.15, -94.02, -48.61, -125.93, 92.08, 24.73])
...
Q = np.radians([
	[
		[-81.76, -119.75, -100.10, -52.95, 89.57, 20.85], 
		[-69.35, -118.42, -104.73, -48.51, 91.39, 20.15], 
		[-57.93, -120.50, -100.75, -48.32, 92.15, 22.29]
	], 
	[
		[-82.67, -122.96, -103.44, -44.24, 91.52, 18.40], 
		[-69.30, -122.70, -103.70, -46.92, 91.04, 20.27], 
		[-57.12, -124.15, -102.91, -43.27, 90.59, 21.79]
	], 
	[
		[-82.60, -126.12, -104.86, -38.81, 91.67, 9.75],
		[-69.18, -124.87, -108.81, -35.14, 91.79, 24.89],
		[-57.03, -126.69, -103.82, -39.58, 90.49, 10.40]
	]
...
def move_block(pub_setjoint, pub_setio, start_loc, start_height, end_loc, end_height):
	...
	move_arm(pub_setjoint, Q[start_height][start_loc])
	time.sleep(2)
	gripper(pub_setio, 1)
	time.sleep(3)
	move_arm(pub_setjoint,home)
	move_arm(pub_setjoint, Q[end_height][end_loc])
	time.sleep(2)
	gripper(pub_setio, 0)
	time.sleep(2)
	return 
